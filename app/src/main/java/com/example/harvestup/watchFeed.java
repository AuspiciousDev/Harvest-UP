...
public class watchFeed extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoPath = "android.resource://" + getPackageName() + "/" + R.raw.feeding;
...
// Prepare the player.
        ...
        speedBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(watchFeed.this);
